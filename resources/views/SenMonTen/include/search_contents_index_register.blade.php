...
?>
<div id="{{$content->id}}" class="col-sm mb-2">
    <div class="card clcard row center" >
      <!-- pc -->
      <div class="hidden-xs">
        <div class="card-block-me p-0">
            ...
            <div class="center">
              <h5 class="border-bottom py-2">
                <a href="/SenMonTen/{!!UtilYoyaku::getNewMenuSenMonTen($content->service)!!}/contents/{!!$content->id!!}/desc">
                  <span><strong>{!!Util::truncateHeaderName($content->name,'pc')!!}</strong></span>
                </a>
              </h5>
            </div>
        ...
        <div class="card-block-me p-0 m-0 row">
            ...
            <div class="col-8 pl-0 pb-1">
              <div class="center">
                <h5 class="border-bottom py-2">
                  <a href="/SenMonTen/{!!UtilYoyaku::getNewMenuSenMonTen($content->service)!!}/contents/{!!$content->id!!}/desc">
                    <span><strong>{!!Util::truncateHeaderName($content->name,'smartphone')!!}</strong></span>
                  </a>
                </h5>
                <div class="border-bottom pb-2 center">
