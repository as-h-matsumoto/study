        ...
        <span>
            ...
            <span class="name pl-4">
                ...
                @if($license_question_try_master->type===2)
                  ...
                  <span class="f20 text-red-800">試験は終了しています。</span>
                  @else
                  <span class="f20">残り時間は<span id="limit" class="text-red-800"></span>です</span>
                  @endif
                @else
                <span class="f20 text-red-800">制限時間はありません。</span>
                @endif
                </p>
            </span>
        </span>
