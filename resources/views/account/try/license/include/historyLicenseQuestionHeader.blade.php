    ...
    <div class="user-info col-12 center bg-mask p-6">
        <span>
            ...
            <span class="name pl-4">
                ...
                <br /><br />
                <span class="f24">
                @if($question_all[$license_question->id]===1)
                <i class="icon icon-check s-7 text-green-300"></i>&nbsp;正解
                @elseif($question_all[$license_question->id]===2)
                <i class="icon icon-triangle-outline s-6 text-yellow-300"></i>&nbsp;一部正解
                @else
                <i class="icon icon-close s-6 text-red-300"></i>&nbsp;不正解
                @endif
                </span>
                @endif
                </p>
