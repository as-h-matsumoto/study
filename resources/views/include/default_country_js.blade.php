...
$(document).ready(function () {
  ...
  .then(function (response) {
    result = response.data;
    var Insert = '';
    @if(Auth::user()->country_area)
    var selected='{!!Auth::user()->country_area!!}';
    @else
    var selected=13;
    @endif
    $.each(result,function(index,val){
    ...
    .then(function (response) {
      result = response.data;
      var Insert = '';
      @if(Auth::user()->country_area_address_one)
      var selected='{!!Auth::user()->country_area_address_one!!}';
      @else
      var selected=13101;
      @endif
      $.each(result,function(index,val){
      ...
      .then(function (response) {
        result = response.data;
        var Insert = '';
        var selected='{!!Auth::user()->country_area_address_two!!}';
        $.each(result,function(index,val){
