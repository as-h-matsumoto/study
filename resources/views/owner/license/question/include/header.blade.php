    ...
    <div class="user-info col-12 center">
        <span>
            ...
            <span class="name pl-4">
                <span class="f24">
                {!!Util::truncateHeaderName($license->name,'page')!!}
                </span>
                <br />
                <span class="f24">
                {!!Util::truncateHeaderName($license_schedule->license_year.'年度','page')!!} &nbsp; {!!Util::truncateHeaderName($license_schedule->license_phase.'次試験','page')!!}　
                </span>
                <br />
                ...
                @endif
                <span class="f24">
                {!!Util::truncateHeaderName($license_examination_subject->name,'page')!!} &nbsp;{!!Util::truncateHeaderName('第'.$license_question->number.'問','page')!!}
                </span>
            </span>
        </span>
    </div>
