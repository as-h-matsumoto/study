...
<div class="form-group col-12 mt-4">
    <label for="CapacityFormname" class="form-control-label"><i class="icon icon-star text-red-700"></i> スタジオ名</label>
...
<div class="form-group col-8 mb-0 pb-0">
    <label for="CapacityFormnumber" class="form-control-label"><i class="icon icon-star text-red-700"></i> スタジオ数</label>
    <input class="form-control form-control-lg center" type="number" value="" name="number" id="CapacityFormnumber" min="1" />
    <span class="help-block" >同一タイプのスタジオが複数ある場合に入力<span>
</div>
