...
function createMenu(menu, use_number){
    ...
    if(use_number) main += '<p class="text-success">[ご利用チケット]</p>';
    ...
    main += '開催時間: ' + menu.time + '分';
    main += '</span><br />';
    if(use_number){
        main += '<span class="pr-1 text-green-500">購入枚数: ' + use_number + '枚</span>';
    }else{
        main += '<span class=" pr-1">枠:' + menu.number + '名</span>';
        main += '<br /><span class=" pr-1">申込:～' + menu.person + '名から</span>';
    }
