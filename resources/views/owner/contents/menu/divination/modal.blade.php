...
<div class="form-group col-sm-6">
    <label for="time" class="form-control-label"><i class="icon icon-star text-red-700"></i> 施術時間(分)</label>
...
<div class="form-group col-sm-6" >
    ...
    <span class="help-block">施術席などを考慮の上、入力してください。予約枠は全メニューのこの値の合計となります。</span>
</div>
