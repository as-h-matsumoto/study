...
<head>
<meta charset="utf-8">
<title>@section('title') 問題登録 @show</title>
...
<body class="layout layout-vertical layout-left-navigation layout-below-toolbar">
  ...
  <div id="wrapper">
    ...
    @include('owner/layouts/owner_menu')

    <div class="content-wrapper">

      @include('owner/layouts/default_toolbar')
...
<script>
function modalContentDeleteConfirm(){
  $('#modalContentDeleteConfirm').modal('show');
}
</script>
