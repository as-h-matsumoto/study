    ...
    <div class="col-sm-12">
    <h4 class="text-info">各曜日・祝日ごとの営業時間</h4>
    </div>
    
    <div class="col-sm-12 border_both">
    <h5 class="text-info">月曜日</h5>
    </div>
    <div class="form-group col-sm-2">
        <label class="custom-control custom-checkbox">
    ...
    <div class="col-sm-12 border_both">
    <h5 class="text-info">年末年始（12/30 ~ 1/3）</h5>
    </div>
    <div class="form-group col-sm-2">
        <label class="custom-control custom-checkbox">
